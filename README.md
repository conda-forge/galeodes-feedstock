...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/galeodes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15463&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/galeodes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `galeodes` can be installed with:

```
conda install galeodes
```

It is possible to list all of the versions of `galeodes` available on your platform with:
